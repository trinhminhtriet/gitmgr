...
use clap::Parser;
use libgitmgr::RepositoryCollector;
use log::debug;
use std::env;
use thiserror::Error;
...
const HELP: &str = "\
More information: https://github.com/trinhminhtriet/gitmgr
...
Config File Usage:
  ...
  common platforms:
    ...
    macOS, Linux, etc.    $HOME/.config/gitmgr.toml
    Windows               {{FOLDERID_Profile}}\\.config\\gitmgr.toml
